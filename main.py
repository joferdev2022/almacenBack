...
from app.routes import products_route, sales_route, dashboard_route, auth_route, seller_route, supplier_route
...
app.include_router(seller_route.router, prefix='/api')
