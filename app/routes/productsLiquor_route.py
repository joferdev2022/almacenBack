...
from app.services.productsLiquor_service import retrieve_products, add_product, delete_product_by_id, update_product_by_id, upload_excel, download_excel
from app.models.productLiquor_model import productModel, ResponseProductModel, ErrorResponseModel
...
@router.get("/productsliquor", tags=["liquor products"])
...
@router.post("/productsliquor", tags=["liquor products"])
async def save_product(product_data: productModel):
    ...
    return ResponseProductModel(product_bd, "Producto creado de forma correcta")
    
@router.put("/productsliquor/{id}", tags=["liquor products"])
...
@router.delete("/productsliquor/{id}", tags=["liquor products"])
...
@router.post("/productsliquor/upload-excel", tags=["liquor products"])
...
@router.get("/productsliquor/download-excel", tags=["liquor products"])
